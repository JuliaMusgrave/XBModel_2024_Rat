...
% Function describing the linearised cross-bridge model presented in "Uncovering 
...
function [OBJ,Y,HxB_comp,HxC_comp,HC_comp,HC_Lcomp,HC_Scomp] = XBmodel_2022_linear(params,data,freqs)
if nargin==1
...
k_2=params(5); % s^-1
K=params(6); % kPa
phi_x=params(7); % unitless 
phi_v=params(8);  % unitless 
phi_s=params(9); % unitless 
phi_l=params(10); % unitless 
